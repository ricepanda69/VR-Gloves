...
namespace Uduino
{
    ...
    public enum UduinoManagerState
    {
        Idle,
        Discovering,
        BoardDetected
    ...
    /*   [Serializable]
       ...
       */
    [Serializable]
    public struct UduinoWiFiSettings
    {
        public string ip;
        public int port;
        public bool enable;
    ...
    public class UduinoManager : MonoBehaviour {
        ...
        /// <summary>
        /// State of the Uduino Manager
        /// </summary>
        public UduinoManagerState ManagerState = UduinoManagerState.Idle;
        ...
        /// Dictionnary containing all the connected Arduino devices
        /// </summary>
        // public List<UduinoWiFiSettings> uduinoWiFiSettings = new List<UduinoWiFiSettings>();

        [SerializeField]
        private List<UduinoWiFiSettings> uduinoWiFiBoards = new List<UduinoWiFiSettings>();
        public List<UduinoWiFiSettings> UduinoWiFiBoards
        {
        ...
        */
        ...
        public string Read(UduinoDevice target, string message = null, Action<string> action = null, string bundle = null)
        {
            UduinoDevice[] devices;
            string readVal = "";
        ...
        /// <param name="action">Action callback</param>
        /// <param name="bundle">Bundle name if any</param>
        public string Read(string message = null, Action<string> action = null, string bundle = null)
        {
            UduinoDevice[] devices;
            string readVal = "";
        ...
        /// <summary>
        /// Read a value from arduino without queue
        /// </summary>
        ...
        public bool ExtensionIsPresent(string extensionName)
        {
            bool isPresent = false;
            presentExtentionsMap.TryGetValue(extensionName, out isPresent);
            return isPresent;
